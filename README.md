...
[![Version 6.119.1](https://img.shields.io/badge/version-6.119.1-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v6.119.1/Ouroboros-6.119.1.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v6.119.1/Ouroboros-6.119.1-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v6.119.1/ouroboros_6.119.1_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.119.1/ouroboros-6.119.1-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.119.1/ouroboros-6.119.1-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.119.1/Ouroboros-6.119.1-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.119.1/Ouroboros-6.119.1-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 6.119.1 | 2026-09-20 | **fix: bump_release_version contract wording corrected per the 6.119.0 triad critical — exception-scope recovery, not a process-crash transaction.** The triad was right: the function performed sequential carrier writes while its docstring claimed "atomic". The contract now says exactly what holds: on any raised failure every snapshotted file is restored to pre-call bytes and the original error re-raises (invalid version / sync exception / post-sync desync leave the tree byte-identical), while carrier writes stay sequential — a crash mid-write can leave a partially synced tree, concurrent readers can observe intermediate states, git is the crash-recovery path, and re-running `sync_release_metadata` re-converges the carriers. A rollback write failure no longer masks the original error: it re-raises with the rollback failure chained in `__cause__`. New test pin `test_rollback_failure_raises_original_with_cause` (monkeypatched `Path.write_bytes`); suite 6 tests / 95 in the file, all green. No behavior change to the happy path. Roll-off this release: 6.118.1 (cap-oldest patch row; six patch rows exceeded the P9 limit of five after this row was added — cap-driven; body at git tag v6.118.1, added to the older-releases enumeration). |
...
Older releases are preserved in Git tags and GitHub releases. Older 6.x rows (including 6.118.1, 6.116.1, 6.116.0, 6.115.1, 6.114.2, 6.114.1, 6.114.0, 6.113.0, 6.112.0, 6.113.5, 6.113.3, 6.113.1, 6.110.1, 6.109.0, 6.108.1, 6.106.0, 6.101.1, 6.97.2, 6.105.0, 6.97.1, 6.97.0, 6.96.1, 6.96.0, 6.95.0, 6.94.0, 6.93.0, 6.92.1, 6.92.0, 6.91.1, 6.90.3, 6.91.0, 6.90.2, 6.90.0, 6.87.5, 6.87.4, 6.87.3, 6.87.2, 6.84.0, 6.87.1, 6.83.0, 6.86.1, 6.81.1, 6.76.0, 6.75.0, 6.74.5, 6.74.4, 6.74.1, 6.74.0, 6.73.2, 6.73.1, 6.73.0, 6.72.0, 6.71.2, 6.71.1, 6.71.0, 6.70.0, 6.69.0, 6.68.0, 6.67.0, 6.66.0, 6.65.4, 6.65.3, 6.65.2, 6.65.1, 6.65.0, 6.64.3, 6.64.2, 6.64.1, 6.64.0, 6.63.0, 6.62.0, 6.61.4, 6.61.3, 6.61.1, 6.61.0, 6.60.0, 6.59.0, 6.58.0, 6.57.0, 6.56.0, 6.55.0, 6.54.4, 6.54.2, 6.54.1, 6.54.0, 6.53.4, 6.53.0, 6.51.0), the 5.2.0 through 5.33.0-rc.6 rows, and former `4.0.0` rows are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
