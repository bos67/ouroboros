...
[![Version 6.118.4](https://img.shields.io/badge/version-6.118.4-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v6.118.4/Ouroboros-6.118.4.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v6.118.4/Ouroboros-6.118.4-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v6.118.4/ouroboros_6.118.4_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.118.4/ouroboros-6.118.4-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.118.4/ouroboros-6.118.4-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.118.4/Ouroboros-6.118.4-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.118.4/Ouroboros-6.118.4-linux-x86_64.tar.gz
...
| 6.116.1 | 2026-09-13 | **patch: SYSTEM.md SSOT dedup (owner-approved Tier A).** The verbatim BIBLE-P9 duplicate (~20 lines: carrier list, `identical_diff_refused`, Max Review Cycles, managed-update M0 mechanics) replaced by a 9-line in-loop summary + visible pointer to BIBLE P9; the in-loop Releases reminder trimmed to spelling-only. `prompts/SYSTEM.md` 69,760 → 68,436 B. Pinned-test surface verified clean (identity_wording, docs_sync, git_review_pipeline, client_surface), 154/154 green; carriers synced, desyncs=[], P9 green. |
| 6.116.0 | 2026-09-07 | **feat: class-aware DEVELOPMENT.md context residency (owner decision, the ARCHITECTURE.md mirror).** In owner-Max the inlined self-engineering handbook renders full only for self-body classes (default-lane pooled tasks, evolution, deep_self_review, review, explicit self-body flag); direct-chat turns receive its lossless H2-H4 navigation map plus a visible on-demand pointer — a relocation, never truncation — offloading ~238 KB (~60K estimated tokens) per direct call. External surfaces keep the on-demand pointer (unchanged); Low mode keeps the full handbook for every inlined class; explicit `context_requires_development` keeps its exact semantics (False → pointer-only, never nav; True → full). `development_full_resident` joins the ContextCore fingerprint so direct-chat and pooled cores with identical text differ; BIBLE.md P1 amended by one phrase (DEVELOPMENT.md residency = owner-selected class-aware posture). DEVELOPMENT.md context matrix + Context mode section and ARCHITECTURE.md §6 synced in the same commit. |
...
Older releases are preserved in Git tags and GitHub releases. Older 6.x rows (including 6.115.1, 6.114.2, 6.114.1, 6.114.0, 6.113.0, 6.112.0, 6.113.5, 6.113.3, 6.113.1, 6.110.1, 6.109.0, 6.108.1, 6.106.0, 6.101.1, 6.97.2, 6.105.0, 6.97.1, 6.97.0, 6.96.1, 6.96.0, 6.95.0, 6.94.0, 6.93.0, 6.92.1, 6.92.0, 6.91.1, 6.90.3, 6.91.0, 6.90.2, 6.90.0, 6.87.5, 6.87.4, 6.87.3, 6.87.2, 6.84.0, 6.87.1, 6.83.0, 6.86.1, 6.81.1, 6.76.0, 6.75.0, 6.74.5, 6.74.4, 6.74.1, 6.74.0, 6.73.2, 6.73.1, 6.73.0, 6.72.0, 6.71.2, 6.71.1, 6.71.0, 6.70.0, 6.69.0, 6.68.0, 6.67.0, 6.66.0, 6.65.4, 6.65.3, 6.65.2, 6.65.1, 6.65.0, 6.64.3, 6.64.2, 6.64.1, 6.64.0, 6.63.0, 6.62.0, 6.61.4, 6.61.3, 6.61.1, 6.61.0, 6.60.0, 6.59.0, 6.58.0, 6.57.0, 6.56.0, 6.55.0, 6.54.4, 6.54.2, 6.54.1, 6.54.0, 6.53.4, 6.53.0, 6.51.0), the 5.2.0 through 5.33.0-rc.6 rows, and former `4.0.0` rows are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
