...
# Class-aware residency classifiers live in the leaf module context_residency
# (extracted to keep this builder below the giant-file threshold); the same
# names are re-imported here so every call site is unchanged.
from ouroboros.context_residency import (  # noqa: F401
    _explicit_self_body_docs_flag,
    _task_architecture_full_resident,
    _task_development_full_resident,
